...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: 'hmao的日记',
      method: 'HEAD',
      target: 'https://blog.hsmao.cn',
      statusPageLink: 'https://blog.hsmao.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'FILE',
      method: 'HEAD',
      target: 'https://iis.hsmao.cn',
      statusPageLink: 'https://iis.hsmao.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '时光动态 API',
      method: 'HEAD',
      target: 'https://api.timens.cn',
      statusPageLink: 'https://api.timens.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Hmao API',
      method: 'HEAD',
      target: 'https://api.hsmao.cn',
      statusPageLink: 'https://api.hsmao.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '时光短链',
      method: 'HEAD',
      target: 'https://dl.timens.cn',
      statusPageLink: 'https://dl.timens.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'hmao的主页',
      method: 'HEAD',
      target: 'https://www.hsmao.cn',
      statusPageLink: 'https://www.hsmao.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '时光动态',
      method: 'GET',
      target: 'https://www.timens.cn',
      statusPageLink: 'https://www.timens.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'hmao的日记（图片存储）',
      method: 'HEAD',
      target: 'https://image.hsmao.cn',
      statusPageLink: 'https://image.hsmao.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '庆典头像',
      method: 'HEAD',
      target: 'https://nda.hsmao.cn',
      statusPageLink: 'https://nda.hsmao.cn',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    }
